...
import { 
  ...
  Target, Rocket, Layers, Code, 
  UploadCloud, Compass, History, FolderHeart 
} from "lucide-react";

export default function Dashboard() {
  return (
    <div className="min-h-screen bg-[#FAFAFA] dark:bg-[#09090B] pb-24 pt-12 md:pt-24 selection:bg-blue-500/30 font-sans">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        
        {/* PAGE HEADER */}
        <header className="mb-12">
          <h1 className="text-4xl md:text-5xl font-bold tracking-tighter text-zinc-900 dark:text-white mb-3">
            Career Dashboard
          </h1>
          <p className="text-lg text-zinc-500 dark:text-zinc-400 font-medium tracking-tight">
...
function InsightBar({ label, percentage, color }: any) {
  return (
    <div>
...
function TimelineItem({ title, subtitle, time, type }: any) {
  const getDotColor = () => {
    switch(type) {
